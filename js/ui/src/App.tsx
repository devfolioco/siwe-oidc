...
const Step = ({
  ...
  return (
    <div
      className={`flex p-5 gap-5 justify-start items-center rounded-lg ${
        isActive
          ? "border-2 border-solid border-blue-3"
    ...
    >
      {isCompleted ? (
        ...
        <div
          className={`flex justify-center items-center rounded-[32px] px-[13px] py-[8px] h-8 w-8 ${
            isActive ? "bg-blue-3" : "bg-gray-bg"
          }`}
        >
          <p
            className={`text-sm font-montserrat font-extrabold ${
              isActive ? "text-white" : "text-gray-6"
            }`}
          >
            {number}
          </p>
        ...
        <div className="h-full w-full md:w-[600px] bg-white md:rounded-b-2xl pt-2 md:pt-8 p-8 flex flex-col justify-between">
          ...
          <div
            className={`flex flex-col w-full ${
              activeStepNumber === 2 ? "justify-between" : "justify-end"
            } gap-4 md:gap-0 md:flex-row  items-center mt-10`}
          >
            {activeStepNumber === 2 && (
              <>
                <p
                ...
                <button
                  ...
                  className={`flex w-full md:w-auto md:h-[42px] justify-center items-center px-6 py-2.5 border border-solid ${
                    isVerifyingAddress
                      ? "bg-blue-2 border-blue-2"
                      : "bg-blue-4 border-blue-4B"
                  } shadow-blue-1 rounded-lg gap-2`}
                >
                  {isVerifyingAddress && (
                    <img
                      src={loader}
